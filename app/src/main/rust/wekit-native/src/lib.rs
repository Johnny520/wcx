...
#[unsafe(no_mangle)]
pub extern "C" fn Java_com_Johnny_wcx_utils_crash_NativeCrashHandler_installNative(
    env: *mut RawJNIEnv,
    _thiz: jobject,
...
/// Java signature: `()V`
#[unsafe(no_mangle)]
pub extern "C" fn Java_com_Johnny_wcx_utils_crash_NativeCrashHandler_uninstallNative(
    _env: *mut RawJNIEnv,
    _thiz: jobject,
) {
...
/// Java signature: `(I)V`
#[unsafe(no_mangle)]
pub extern "C" fn Java_com_Johnny_wcx_utils_crash_NativeCrashHandler_triggerTestCrashNative(
    _env: *mut RawJNIEnv,
    _thiz: jobject,
    crash_type: jint,
) {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn Java_com_Johnny_wcx_features_items_chat_MarkdownRendering_convertMarkdownToHtmlNative(
    env: *mut RawJNIEnv,
    _thiz: jobject,
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_com_Johnny_wcx_utils_AudioUtils_anyToSilk(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    any_path: jstring,
    silk_path: jstring,
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_com_Johnny_wcx_utils_AudioUtils_silkToPcm(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    silk_path: jstring,
    pcm_path: jstring,
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_com_Johnny_wcx_utils_AudioUtils_pcmToMp3(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    pcm_path: jstring,
    mp3_path: jstring,
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_com_Johnny_wcx_utils_AudioUtils_getDurationMs(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    path: jstring,
) -> jlong {
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_com_Johnny_wcx_utils_TelegramStickerConverter_tgsToGifNative(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    input_path: jstring,
    output_path: jstring,
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_com_Johnny_wcx_utils_TelegramStickerConverter_webmToGifNative(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    input_path: jstring,
    output_path: jstring,
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_com_Johnny_wcx_utils_SignatureVerifier_nativeVerify(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    context: jobject,
