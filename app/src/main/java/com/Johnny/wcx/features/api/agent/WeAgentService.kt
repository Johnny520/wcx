package com.Johnny.wcx.features.api.agent

import androidx.compose.runtime.mutableStateListOf
import androidx.compose.runtime.mutableStateOf
import androidx.compose.runtime.snapshots.SnapshotStateList
import com.Johnny.wcx.agent.data.WeAgentDatabase
import com.Johnny.wcx.agent.data.WeAgentRepository
import com.Johnny.wcx.agent.data.WeAgentSettings
import com.Johnny.wcx.agent.data.entity.ApprovalStatus
import com.Johnny.wcx.agent.data.entity.MessageRole
import com.Johnny.wcx.agent.engine.AgentEvent
import com.Johnny.wcx.agent.engine.AgentSessionContext
import com.Johnny.wcx.agent.engine.AgentSessionEngine
import com.Johnny.wcx.agent.engine.ApprovalGateway
import com.Johnny.wcx.agent.engine.ManualApprovalHandler
import com.Johnny.wcx.agent.engine.ManualApprovalResult
import com.Johnny.wcx.agent.engine.PendingApproval
import com.Johnny.wcx.agent.engine.PromptComposer
import com.Johnny.wcx.agent.engine.SmallModelRef
import com.Johnny.wcx.agent.engine.TurnConfig
import com.Johnny.wcx.agent.mcp.McpClientManager
import com.Johnny.wcx.agent.model.LlmToolCall
import com.Johnny.wcx.agent.model.ModelProviderManager
import com.Johnny.wcx.agent.net.ExternalServiceId
import com.Johnny.wcx.agent.tool.BuiltinToolProvider
import com.Johnny.wcx.agent.tool.ToolRegistry
import com.Johnny.wcx.agent.ui.UiImageSink
import com.Johnny.wcx.agent.workspace.VfsContext
import com.Johnny.wcx.agent.workspace.WorkspaceStore
import com.Johnny.wcx.features.api.agent.WeAgentService.ballState
import com.Johnny.wcx.features.api.agent.WeAgentService.handleEvent
import com.Johnny.wcx.features.api.agent.WeAgentService.init
import com.Johnny.wcx.features.api.agent.WeAgentService.messageListState
import com.Johnny.wcx.features.api.agent.WeAgentService.messageListSyncedSessionId
import com.Johnny.wcx.features.api.agent.WeAgentService.newSession
import com.Johnny.wcx.features.api.agent.WeAgentService.pendingApproval
import com.Johnny.wcx.features.api.agent.WeAgentService.pendingApprovals
import com.Johnny.wcx.features.api.agent.WeAgentService.resolveTurnConfig
import com.Johnny.wcx.features.api.agent.WeAgentService.runTurn
import com.Johnny.wcx.features.api.agent.WeAgentService.runningTurns
import com.Johnny.wcx.features.api.agent.WeAgentService.sendMessage
import com.Johnny.wcx.features.api.agent.WeAgentService.switchSession
import com.Johnny.wcx.features.api.agent.WeAgentService.syncForeground
import com.Johnny.wcx.features.api.agent.WeAgentService.uiMessages
import com.Johnny.wcx.features.api.agent.WeAgentService.uiSessions
 ...
 * UI. Lives in WeChat's main process; initialized once when the [com.Johnny.wcx] WeAgent feature
 * is enabled.
 *
 ...
 * logic lives here.
 */
object WeAgentService : com.Johnny.wcx.agent.trigger.TriggerManager.TriggerHost {
    ...
    val triggerManager = com.Johnny.wcx.agent.trigger.TriggerManager(scope, this)
    ...
    val currentUsage = mutableStateOf<com.Johnny.wcx.agent.model.LlmUsage?>(null)
    ...
    data class ChatRow(
        ...
        /** Persisted [createdAt] from [com.Johnny.wcx.agent.data.entity.MessageEntity]; [java.time.Instant.EPOCH] for live-streaming rows. */
     ...
     * or null if no model is configured. [com.Johnny.wcx.agent.trigger.TriggerManager.TriggerHost] impl.
     */
    ...
    private suspend fun switchSessionInternal(id: String) {
        ...
        withContext(Dispatchers.Main) {
            ...
            currentUsage.value = session?.let {
                ...
                else com.Johnny.wcx.agent.model.LlmUsage(it.promptTokens, it.completionTokens, it.totalTokens)
            }
    ...
    private suspend fun buildEngine(sessionId: String, promptAnchorTime: java.time.Instant): AgentSessionEngine {
        val composer = PromptComposer(
            ...
            skillCatalog = com.Johnny.wcx.agent.skill.SkillStore.enabledSkills().map { it.name to it.description },
