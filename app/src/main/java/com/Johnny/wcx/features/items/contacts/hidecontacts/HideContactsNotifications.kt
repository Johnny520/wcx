 ...
 * feature modelled on
 * [com.Johnny.wcx.features.items.notifications.NotificationsEvolved], which already opts into
...
object HideContactsNotifications : ApiFeature(), IResolveDex {
     ...
     * [com.Johnny.wcx.features.items.notifications.NotificationsEvolved]'s, deliberately — if it
