...
import com.Johnny.wcx.agent.jvm.JvmValueBridge
import com.Johnny.wcx.agent.model.LlmImage
import com.Johnny.wcx.agent.ui.UiAutomator
import com.Johnny.wcx.agent.ui.UiImageSink
import com.Johnny.wcx.features.core.AgentTool
import com.Johnny.wcx.features.core.AgentTool.Companion.BUILTIN_UI
import com.Johnny.wcx.features.core.AgentToolParam
...
object WeUiAutomationToolBindings {
    ...
    fun uiInputText(
        ...
        JvmValueBridge.onMain {
            val act = com.Johnny.wcx.utils.android.getTopMostActivity()
                ?: throw com.Johnny.wcx.agent.jvm.JvmBridgeException("No top-most activity")
            val focused = act.currentFocus
                ?: throw com.Johnny.wcx.agent.jvm.JvmBridgeException("No focused view")
