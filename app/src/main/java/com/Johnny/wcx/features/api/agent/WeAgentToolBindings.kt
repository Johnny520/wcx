...
import com.Johnny.wcx.features.items.system.servers.WeChatService.Result

/**
 * The built-in WeAgent tool surface. Every `@AgentTool` function here is discovered by the
 * [com.Johnny.wcx.features.AgentToolScanner] KSP processor and registered in the generated
